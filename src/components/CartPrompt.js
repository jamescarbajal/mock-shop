...
export default function PromptModal(props) {
    ...
    const { isPromptOpen, setIsPromptOpen, isModalLoading, setIsModalLoading, category, description, id, image, price, title, setConfirmRemove } = props;
    ...
    return(
            <ReactModal style={{ overlay: { top: '60px', border: 'none', zIndex: '1' } }} isOpen={isPromptOpen}>
